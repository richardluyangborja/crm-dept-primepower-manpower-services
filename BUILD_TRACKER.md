...
| 2B | Finance section (mock + light workflows) | 🔄 | `feature/crm-finance` | — | Invoices table+AR aging+pay/collect, Finance nav section, client finance tab w/ invoice list; tests green, live smoke OK (buckets reconcile, pay, collect); pushing for CI |
