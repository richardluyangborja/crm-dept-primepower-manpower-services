...
| 2D | BI expansion + `crm-v1.2.0` release | ✅ | `feature/crm-bi-trends` | to open (base `develop`) | Pushed (5d5e615), CI green — trends.monthly, shared Recharts card, METHODOLOGY §2b; open PR to `develop`, then release + tag `crm-v1.2.0` |
