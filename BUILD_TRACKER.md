...
## Overhaul Phase 6 — seed consistency + release — MERGED to `main`
...
| Spec 12 volumes + final release | ✅ | Suite green (688 assertions), build green, CI green |
...
| `EscalationTest` (3 tests) | ✅ | Suite green (682 assertions), build green, CI green, live smoke on dev DB |
...
| Item | Status | Notes |
|---|---|---|
| Rename to Primepower Team, retire Manila/Cebu/Davao | ✅ | Migration re-homes stragglers, deletes legacy teams; fixed silent `whereKey`-on-Query-Builder bug (also in Gov-3 `down()`) |
...
| Specs 02/09/12 + team tests renamed | ✅ | Suite green (636 assertions), build green, CI green |
