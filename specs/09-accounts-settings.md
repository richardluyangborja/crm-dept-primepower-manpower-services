...
| Organization | superadmin/admin | single “Primepower Sales” team (membership automatic; management UI hidden), regions, master data: industries, sources, stages labels, lost reasons |
