...
| Organization | superadmin/admin | single “Primepower Team” (membership automatic; management UI hidden), regions, master data: industries, sources, stages labels, lost reasons |
