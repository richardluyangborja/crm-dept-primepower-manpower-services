...
class LeadClientTest extends TestCase
{
    ...
    public function test_rep_captures_lead_with_score_and_duplicate_warning(): void
    {
        ...
        $t = $this->token($rep);
        $payload = [
            'company_name' => 'BGC Tech Solutions Inc.', 'contact_name' => 'Paolo Gutierrez',
        ...
        // Same phone again → still created, but warns with existing id.
        $second = $this->postJson('/api/v1/leads', $payload + ['company_name' => 'BGC Tech Duplicate'], ['Authorization' => "Bearer $t"])
            ->assertCreated();
    ...
    public function test_ph_phone_validated(): void
    {
        ...
        $this->postJson('/api/v1/leads', [
            'company_name' => 'X', 'contact_name' => 'Y', 'contact_phone' => '09171234567',
    ...
    public function test_reps_only_see_own_leads(): void
    {
        ...
        $this->postJson('/api/v1/leads', ['company_name' => 'A Corp', 'contact_name' => 'A'], ['Authorization' => 'Bearer '.$this->token($a)])->assertCreated();
    ...
    public function test_convert_creates_client_contact_and_is_idempotent(): void
    {
        ...
        $leadId = $this->postJson('/api/v1/leads', [
            'company_name' => 'Davao Prime Hotel', 'contact_name' => 'Mark Villanueva',
    ...
    public function test_unqualified_requires_reason_and_delete_is_admin_only(): void
    {
        ...
        $t = $this->token($rep);
        $leadId = $this->postJson('/api/v1/leads', ['company_name' => 'Z Corp', 'contact_name' => 'Z'], ['Authorization' => "Bearer $t"])->assertCreated()->json('data.id');
